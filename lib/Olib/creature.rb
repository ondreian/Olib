...
module Olib
  class Creature < Gameobj_Extender
    ...
    def injuries
      ...
      if woundinfo =~ /minor bruises on (his|her|its) neck/                                         then @wounds[:neck]       = 1;  end
      ...
      if woundinfo =~ /deep gashes and serious bleeding on (his|her|its) back/                      then @wounds[:back]       = 3;  end
